...
public class SignUpActivity extends BasicActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        moveTaskToBack(true);
        android.os.Process.killProcess(android.os.Process.myPid());                                     // part3 : 뒤로가기 버튼 누를 시 앱 종료[강제종료의 느낌] (30')
        System.exit(1);
    }
    ...
    private void signUp() {
        ...
        if(email.length() > 0 && password.length() > 0 && passwordCheck.length() > 0){                  // part2 : 회원가입 조건
